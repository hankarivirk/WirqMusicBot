...
async def play_hndlr(
    ...
    if not file.file_path:
        # Full download before playing, every time — reliable and
        # proven. (Direct CDN-URL streaming was tried here and caused
        # silent/no-audio playback, so this stays on the safe path.)
