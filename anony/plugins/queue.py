...
async def _queue_func(_, m: types.Message):
    ...
    if not _queue:
        # Playback can end between the get_call() check above and this
        # line (stream ended, /stop ran concurrently, etc.) — without
        # this, an empty queue here would crash on _queue[0] below.
